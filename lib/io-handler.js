...
proto.cleanFolders = function() {
  const q = [ this.cleanFolder(globals.RAW_DIR, 'txt'),
  this.cleanFolder(globals.PARSED_DIR, 'json'),
  this.cleanFolder(globals.ANALYSIS_DIR, 'json') ];
  return Promise.all(q);
};

proto.cleanFolder = function(folderPath, extension) {
...
proto.parseTranscripts = function() {
